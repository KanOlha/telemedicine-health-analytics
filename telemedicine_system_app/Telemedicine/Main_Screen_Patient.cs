...
namespace Telemedicine
{
    public partial class Main_Screen_Patient : Form
    {
        ...
        public Main_Screen_Patient(int userId)
        {
            InitializeComponent();
        ...
        private void Main_Screen_Patient_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = controller.Show_Appointments_list_for_Patient(UserId);
            dataGridView2.DataSource = controller.Show_Doctors_list(UserId);
            label14.Font = new Font(label1.Font, label1.Font.Style | FontStyle.Bold);
            label15.Text = " ";
            label16.Text = " ";
            label17.Text = " ";

            int totalPatients = controller.Total_doctors(UserId);
        ...
        string selectedDoctorName = string.Empty;
        ...
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                selectedDoctorName = dataGridView2.Rows[e.RowIndex].Cells["full_name"].Value.ToString();
                ...
                dataGridView2.DataSource = controller.Show_Diagnosis(UserId, selectedDoctorName);
            }
            ...
            if (dataGridView2.Columns[e.ColumnIndex].Name == "appointment_id")
            {
                ...
                else if (hasP)
                {
                    ...
                    label16.Visible = true;
                    label16.Font = new Font(label1.Font, label1.Font.Style | FontStyle.Bold);
                    dataGridView2.DataSource = controller.Show_Prescription(UserId, currentAppointmentId);
                }
                else if (hasV)
                {
                    label15.Font = new Font(label1.Font, label1.Font.Style | FontStyle.Regular);
                    ...
                    label16.Visible = true;
                    label16.Font = new Font(label1.Font, label1.Font.Style | FontStyle.Bold);
                    dataGridView2.DataSource = controller.Show_Vital_signs(UserId, currentAppointmentId);
                }
            }
        }
        ...
        private void label14_Click(object sender, EventArgs e)
        {
            ...
            label16.Text = " ";
            label17.Text = " ";
            dataGridView2.DataSource = controller.Show_Doctors_list(this.UserId);
        }

        private void label15_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(selectedDoctorName)) return;
            label15.Font = new Font(label1.Font, label1.Font.Style | FontStyle.Bold);
            ...
            dataGridView2.DataSource = controller.Show_Diagnosis(this.UserId, selectedDoctorName);
        }
